...
class EventToC extends $pb.GeneratedMessage {
  factory EventToC({
    $core.int? type,
  ...
  EventToC._() : super();
  factory EventToC.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory EventToC.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EventToC', createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  EventToC clone() => EventToC()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EventToC copyWith(void Function(EventToC) updates) => super.copyWith((message) => updates(message as EventToC)) as EventToC;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static EventToC create() => EventToC._();
  EventToC createEmptyInstance() => create();
  static $pb.PbList<EventToC> createRepeated() => $pb.PbList<EventToC>();
  @$core.pragma('dart2js:noInline')
  static EventToC getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EventToC>(create);
  static EventToC? _defaultInstance;
